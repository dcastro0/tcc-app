import { saveMeasurement } from "@/services/orm/entities/measurement"
      ...
      <Modal animationType="fade" transparent={true} visible={modalVisivel} onRequestClose={handleFecharModal}>
        <View style={tw`flex-1 justify-center items-center bg-black/60`}>
          <View style={tw`bg-white w-4/5 rounded-3xl p-6 items-center`}>
            ...
            <Text style={tw`text-slate-500 text-center mb-4`}>Ótimo trabalho! Manter seus registros em dia é fundamental.</Text>
            <View style={tw`bg-yellow-100 rounded-full px-4 py-2 mb-6`}>
              <Text style={tw`text-lg font-bold text-yellow-700`}>✨ +50 Pontos!</Text>
            </View>
            <Pressable
