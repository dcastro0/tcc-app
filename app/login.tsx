                ...
                >
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            <View style={tw`mb-4`}>
                                <View style={tw`flex-row items-center bg-white rounded-2xl p-4 shadow-sm ${errors.email ? 'border-2 border-red-500' : 'border-2 border-transparent'}`}>
                                ...
                                {errors.email && <Text style={tw`text-red-500 mt-1 ml-2`}>{errors.email.message}</Text>}
                            </View>
                        )}
                    />
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            <View style={tw`mb-4`}>
                                <View style={tw`flex-row items-center bg-white rounded-2xl p-4 shadow-sm ${errors.password ? 'border-2 border-red-500' : 'border-2 border-transparent'}`}>
                                ...
                                {errors.password && <Text style={tw`text-red-500 mt-1 ml-2`}>{errors.password.message}</Text>}
                            </View>
                        )}
                    />
                    ...
                    <View style={tw`flex-row justify-center mt-8`}>
                        ...
                        <Pressable><Text style={tw`text-blue-600 font-bold`}>Cadastre-se</Text></Pressable>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
        </SafeAreaView>
